...
View html <a href="https://github.com/nycdatasci/bootcamp006_project/blob/master/Project1-ExploreVis/Spencer_Stebbins/ExploratoryVizProject.html">HERE</a>
...
student_loan_federal_asset_data$student_loan_as_percentage_federal_assets = student_loan_federal_asset_data$student_loan_asset/total_federal_asset

data <- join_all(list(data,student_loan_as_percentage_federal_assets), by='Date', type = "outer")
...
##-------------------------------------
student_loan_as_percentage_federal_assets <- select(data,Date, student_loan_as_percentage_federal_assets)
student_loan_as_percentage_federal_assets <- melt(student_loan_as_percentage_federal_assets ,id = 'Date', value.name='Percent')
ggplotly(ggplot(student_loan_as_percentage_federal_assets , aes(x=Date,y=Percent,group=variable,color=variable)) + geom_line() + ggtitle('Student Loans as Percent of Federal Assets') +  theme(legend.position="none") + theme_fivethirtyeight())
```
...
```{r, echo = FALSE, warning = FALSE}
##-------------------------------------
##PLOT 6 - Increasing College Costs
##-------------------------------------
