---
title: "Impact of HbA1c Measurement on Diabetes Medications and Hosiptal Readmission"
author: "Jingyu Zhang"
date: "July 17, 2016"
...
- Diabetes disbtribution in age and race 
- The primary diagnosis population before the second diebetes diagnosis
- The impact of H1bAc test result on medication numbers for each primary diagnosis
- The impact of H1bAc test result on hospital readmission ratio for each primary diagnosis
- Summary
...
## The diabbetic population in age and race
...
## HbA1c test affacts medication numbers for each primary diagnosis
...
## HbA1c test affacts hospital readmittted ratio for each primary diagnosis
...
- The people with diabetes are calssified into three groups in age (0-30,30-60,60-90). The diabetes population of White and Afarica American is more than that of Asian and Hispanic.  
- The H1bAc test resulting in similar impact on medication numbers and hopital readmissionratio.
- The relationship between the readmission ratio and the HbA1c measurement signicantly depends on the primary diagnosis. 
