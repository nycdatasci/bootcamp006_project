    ...
    dashboardBody(
        tabItems(
            tabItem(tabName = "map1",
                    ...
                    fluidRow(box(htmlOutput("map"), title='US GDP Colored Map', collapsable=T, height = 380,width=12, solidHeader = F,background='teal')),
                    fluidRow(box(htmlOutput('table1'),height = 325,width=4),
                             box(htmlOutput('barPlot'),height= 325,width=8,background='teal'))),
            ...
            tabItem(tabName = "bubble2",
                    ...
                    fluidRow(box(htmlOutput("bubble2"), height=325,width = 12,background='blue'))),
